...
#define PIN_DMD_CLK       _BV(PINB5)	// D13_SCK  is SPI Clock if SPI is used
#define PIN_DMD_SCLK      _BV(PINC5)	// A5
...
//DMD I/O pin macros
#define LIGHT_DMD_ROW_01_05_09_13()       { PORTC &= ~PIN_DMD_B;	PORTC &= ~PIN_DMD_A; }
#define LIGHT_DMD_ROW_02_06_10_14()       { PORTC &= ~PIN_DMD_B;	PORTC |=  PIN_DMD_A; }
